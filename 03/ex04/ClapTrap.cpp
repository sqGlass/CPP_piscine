...
/*   Updated: 2021/04/20 16:55:08 by sglass           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
  ...
  _max_energy_points(max_energy_points), _level(1), _name(name), _melee_atack_damage(melee_atack_damage), _ranged_attack_damage(ranged_attack_damage), _armor_dmg_reduct(armor_dmg_reduct)
{
	...
	std::cout << "ClapTrap1 constructor!" << std::endl;
	return ;
}
...
{
	std::cout << "ClapTrap2 constructor!" << std::endl;
	return;
}

ClapTrap::ClapTrap( void )
{
	std::cout << "ClapTrap3 constructor!" << std::endl;
	return ;
}
