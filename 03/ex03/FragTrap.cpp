...
/*   Updated: 2021/04/19 18:48:05 by sglass           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "FragTrap.hpp"

FragTrap::FragTrap( void ): ClapTrap(100, 100, 100, 100, "Robo", 30, 20, 5)
{
	std::cout << this->_name << " BOOOORN!" << std::endl;
	return ;
}

FragTrap::FragTrap( std::string const &name ): ClapTrap(100, 100, 100, 100, name, 30, 20,5)
{
	std::cout << this->_name << " BOOOORN!" << std::endl;
	return ;
}
