...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/18 19:01:48 by sglass            #+#    #+#             */
/*   Updated: 2021/04/19 14:16:55 by sglass           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

ScavTrap::ScavTrap( void ) : _hit_points(100), _max_hit_points(100), _energy_points(50),
_max_energy_points(50), _level(1), _name("Robo"), _melee_atack_damage(20),
_ranged_attack_damage(15), _armor_dmg_reduct(3)
{
	std::cout << this->_name << " jumped from heaven!" << std::endl;
	return ;
}

ScavTrap::ScavTrap( std::string const &name ) : _hit_points(100), _max_hit_points(100), _energy_points(50),
_max_energy_points(50), _level(1), _name(name), _melee_atack_damage(20),
_ranged_attack_damage(15), _armor_dmg_reduct(3)
{
	std::cout << this->_name << " jumped from heaven!" << std::endl;
	return ;
