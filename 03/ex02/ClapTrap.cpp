...
/*   Updated: 2021/04/19 16:07:20 by sglass           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap( int energy_points, int max_energy_points, std::string name, int melee_atack_damage, int ranged_attack_damage, int armor_dmg_reduct) : _hit_points(100), _max_hit_points(100), _energy_points(energy_points),
