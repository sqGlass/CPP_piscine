...
/*   Updated: 2021/04/30 12:09:00 by sglass           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(Form const & form)
{
	...
	{
		std::cout << *this << " cannot execute " << form << " because level is too low" << std::endl;
		return ;
	}
	if (!form.getIsSigned())
	{
		std::cout << *this << " cannot execute " << form << " because form didnt sign" << std::endl;
		return ;
	}
	else
	{
